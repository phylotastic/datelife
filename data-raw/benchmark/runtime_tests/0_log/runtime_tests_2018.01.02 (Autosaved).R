...
library(ggplot2)
setwd("~/GoogleDrive/datelife/runtime_tests/2_tests/1_same_spp_names")
...
# length(res)
# str(res)
# load('~/GoogleDrive/datelife/runtime_tests/2_tests/0_all_names/aves.all.gfr.runtime_2017.12.29.RData')
# aves.all.gfr.runtime_2017.12.29
# res <- rbind(res, aves.all.gfr.runtime_2017.12.29)
# ggplot2:::autoplot.microbenchmark(res)
