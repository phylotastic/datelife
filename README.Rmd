...
library(datelife)
```
<img src='inst/figures/datelife-hex-upwards.png' align="right" height="150" />
...
and the congruification method ([Eastman et al. 2013](https://doi.org/10.1111/2041-210X.12051))
