...
The best option to document your checks currently is the [rhub](https://cloud.r-project.org/web/packages/rhub/vignettes/rhub.html) package, which allows remote testing on several OS with:
