...
[DateLife's interactive website application](`r ifelse(website_down, "http://phylotastic.org/datelife/articles/404.html", "http://datelife.opentreeoflife.org/query/")`). `r if (website_down) "However, the website is not up at the moment, apologies."`
