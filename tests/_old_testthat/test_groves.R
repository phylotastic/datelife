...
test_that("median and sdm give a tree when source trees have different degrees of overlapping names", {
    x1 <- summarize_datelife_result(datelife_query = subset2_query,
      datelife_result = subset2_result, summary_format = "phylo_median")
    expect_true(inherits(summarize_datelife_result(datelife_query = subset2_query,
      datelife_result = subset2_result, summary_format = "phylo_median"), "phylo"))
    expect_true(inherits(summarize_datelife_result(datelife_query = subset2_query,
      datelife_result = subset2_result, summary_format = "phylo_sdm"), "phylo"))
    expect_equal(class(summarize_datelife_result(datelife_query = subset2_query,
      datelife_result = subset2_result, summary_format = "newick_median")), "character")
    expect_equal(class(summarize_datelife_result(datelife_query = subset2_query,
      datelife_result = subset2_result, summary_format = "newick_sdm")), "character")
})
