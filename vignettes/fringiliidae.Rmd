...
```r
dquery <- datelife::make_datelife_query(input = "fringilidae",               
...
We have 289 species names in the family Fringiliidae and we did not provide an input tree, so `$phy` is `NA`.
