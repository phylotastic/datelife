...
This allows you to straightforwrdly use them later to perform a search for ages across the `datelife` chronogram database. You have two general ways of providing organism names:
