...
<!--TODO: add something about NJ, why is this happening

One can use a clustering method like Neighbor Joining (NJ). While we implemented this method in the package, because NJ are greedy algorithms they do not perform well and often return topologies that are not biologically plausible. Hence, we implement
a different workflow, -->

To see a case study application of `datelife`, go to the next tutorial vignette: [Case Study: the true finches](fringiliidae.html).
