...
Let's save our `datelifeQuery` for the next section:
...
`summary_format = "citations"` will give back study citations from all  original chronograms matching your search:
