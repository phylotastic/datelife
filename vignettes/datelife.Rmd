...
accomplished with `datelife_search()` function. Taxa of interest must be provided
as scientific names, either in a character vector or in a tree in phylo or newick
format with the scientific names as tip labels. Upper and lower case are ignored.
...
You can use the datelife_query function first to check that your names are accepted. If you are unsure about the spelling or synonyms, you can use arguments bla and bla. These are services of rphylotastic package implemented here.
